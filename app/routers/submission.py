...
def make_submission(submissions:schemas.Submissions, 
    ...
    print("health check")
    submission_df : pd.DataFrame = pd.DataFrame(jsonable_encoder(submissions.submissions),)
    print(submission_df)
    ...
    for response in responses:
        ...
        submission = models.Submission(**response,student_id=user.id, assessment_id=submissions.assessment_id)
